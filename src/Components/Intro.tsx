	...
	return (
		<section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0'>
			...
			<h1 className='mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl text-slate-300 flex flex-col'>
				<span className='font-bold'>Hi there! I'm Allen Tokjuman.</span>
				<span className='font-bold'>I'm a full-stack software engineer</span>
				<span className='font-bold'>with 5 years of experience building</span>
				<span className='font-bold'>professional web applications.</span>
			</h1>
