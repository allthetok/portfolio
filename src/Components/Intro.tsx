		...
		<section ref={ref} id='home' className='mb-24 max-w-[50rem] text-center h-[125vh]'>
			<div className='mt-56'>
				...
				<div className='flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium'>
					...
					<a className='group bg-zinc-200 text-black px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-zinc-700 hover:text-slate-100 active:scale-105 transition' href='/AllenTok_Resume.pdf' download>
						Download Resume
