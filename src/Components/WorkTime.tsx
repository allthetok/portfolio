...
const WorkTime = () => {
	...
	return (
		...
		<section ref={ref} id='work' className='min-h-[100vh] mb-0 text-center pb-12 background-gradient-large w-full'>
			<div className='flex flex-col'>
				<div className='flex flex-row justify-center max-w-[72rem] mx-auto work-time-dir gap-x-16'>
