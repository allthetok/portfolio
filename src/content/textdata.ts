...
const timelineDataSWE: TimeLineDtl[] = [
	...
	},
	{
		...
		title: 'Software Engineer Intern',
		company: 'Solutions Stores Inc.',
		details: "Contributed to a start-up virtual health clinic app for family practice clinics in Ontario as part of an agile team. Led a significant internship project collaborating with UI/UX Designers and a Project Manager to organize Kanban boards, develop timelines, and gather client requirements. Successfully deployed a registration portal for clinics on AWS, using React, SASS, Bootstrap and a Django/Postgres REST API, and integrated with existing Kubernetes clusters to securely pass data to user-app Docker containers, cache results in Redis store, and streamline sign-up flow. Helped in migrating AWS EC2 instances, security rules & tasks to Fargate, reducing maintenance and monthly server costs by 15%.",
		skills: ['React', 'Django', 'AWS', 'Kubernetes', 'AKS', 'Redis', 'Docker', 'Bootstrap', 'AGILE', 'Git', 'Jira & Bitbucket', 'Python', 'Javascript', 'HTML', 'SASS', 'Typescript', 'Cypress Unit Testing', 'Twilio', 'Serverless' ]
	}
]
