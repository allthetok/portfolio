...
const timelineDataSWE: TimeLineDtl[] = [
	{
		...
		skills: ['C#', 'Azure', 'AKS', 'SQL', 'ASP.NET', 'React', 'Jest', 'VB', 'SSO', 'AGILE', 'MSTest', 'Selenium', 'RESTful API', 'Database Maintenance', 'Project Management']
	},
	{
		from: 'Apr',
		to: 'Sep 2020',
		...
		skills: ['React', 'Django', 'AWS', 'Kubernetes', 'Docker', 'Bootstrap', 'AGILE', 'Git', 'Jira & Bitbucket', 'Python', 'Javascript', 'HTML', 'SASS', 'Typescript', 'Cypress Unit Testing', 'Twilio', 'Serverless' ]
	}
]
